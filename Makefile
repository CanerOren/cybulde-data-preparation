...
GCP_DOCKER_IMAGE_NAME = europe-west4-docker.pkg.dev/emkademy-474323/cybulde/cybulde-data-processing
...
## Processes raw data. For running it local and debugging
