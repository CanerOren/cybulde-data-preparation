...
def process_data(config: Config) -> None:
    ...
    dvc_remote_repo = "https://github.com/CanerOren/cybulde-data.git"
    dvc_data_folder = "data/raw"
    github_user_name = "CanerOren"
    github_access_token = access_secret_version("emkademy-474323", "cybulde-data-github-access-token")
