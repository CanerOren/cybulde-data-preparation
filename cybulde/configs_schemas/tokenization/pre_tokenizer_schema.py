...
SPLIT_DELIMITER_BEHAVIOUR_OPTIONS = {"removed", "isolated", "merged_with_previous", "merged_with_text", "contiguous"}
...
class SplitPreTokenizerConfig(PreTokenizerConfig):
    _target_: str = "tokenizers.pre_tokenizer.Split"
    pattern: str = MISSING
...
def setup_config() -> None:
    ...
    cs.store(
        group="tokenizer/pre_tokenizer",
        name="white_space_split_pre_tokenizer_schema",
