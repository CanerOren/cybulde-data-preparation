...
def setup_config() -> None:
    ...
    cs.store(group="tplemozer/post_processor", name="bert_post_processing_schema", node=BertPostProcessorConfig)

    cs.store(
        group="tplemozer/post_processor", name="byte_level_post_processing_schema", node=ByteLevelPostProcessorConfig
    )

    cs.store(group="tplemozer/post_processor", name="roberta_post_processing_schema", node=RobertaPostProcessorConfig)
